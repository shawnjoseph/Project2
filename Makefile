...
CommandProcessor.o: main.cpp CommandProcessor.cpp Menu.cpp DynQueue.h DynStack.h HashNode.h HashMap.h
		g++ -std=c++11 main.cpp CommandProcessor.cpp Menu.cpp DynQueue.h DynStack.h HashNode.h HashMap.h
